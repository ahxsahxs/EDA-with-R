...
$$AumentoRelativo = {{Populacao \; inicial} \over {Populacao \; final}}$$
...
1. Criação de objetos
    ...
    1.2. Crie uma matriz contendo os dados destes dois vetores. Esta matriz de ter 10 linhas (uma para cada aluno) e duas colunas (uma para a idade e outra para o sexo).
